      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Discover our most loved properties with exceptional ratings and
            reviews from guests around the world.
          </p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {hotels.map((hotel) => (
              <HotelCard
                ...
                rating={hotel.rating || 4.5} // Fallback to a default rating if not available
