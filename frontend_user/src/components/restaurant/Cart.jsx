...
export function Cart({ isOpen, onClose, cartItems, onUpdateQuantity, onRemoveItem, total, bookingId }) {
                    ...
                    <div className="flex-1 space-y-1">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1">
                          <button className="h-6 w-6 flex items-center justify-center border rounded-md" onClick={() => onUpdateQuantity(item.id, item.quantity - 1)}>
                ...
                onClick={async () => {
                  try {
                    ...
                    const response = await axios.post(
                      "http://localhost:3000/api/v1/hotels/1/orders",
                      orderData
                    );
